...
/*
#define USART_DEBUG USARTE0
#define USART_DEBUG_PORT PORTE
#define USART_DEBUG_RXVECT USARTE0_RXC_vect
*/

//**
#define USART_DEBUG USARTC0
#define USART_DEBUG_PORT PORTC
#define USART_DEBUG_RXVECT USARTC0_RXC_vect
//**/

#define USART_XBEE USARTE0
#define USART_XBEE_PORT PORTE
#define USART_XBEE_RXVECT USARTE0_RXC_vect
#define USART_XBEE_TXVECT USARTE0_TXC_vect

//*
#define USART_USB USARTD0
#define USART_USB_PORT PORTD
#define USART_USB_RXVECT USARTD0_RXC_vect
//*/

/**
#define USART_USB USARTD1
#define USART_USB_PORT PORTD
#define USART_USB_RXVECT USARTD1_RXC_vect
**/
